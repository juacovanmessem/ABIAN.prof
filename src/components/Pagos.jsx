      ...
      <div className='my-3'>
        ...
        <div className='row g-0 justify-content-evenly my-3'>
          <div className='col-10 col-md-5 border p-3'>
            <p className='text-center'><strong>Formación para Nutricionistas, Terapeutas y personal de la Salud</strong></p>
            <p>El valor del curso es:</p>
            <p>🇦🇷 Argentina: U$D 40</p>
            <p>🌎 Latinoamérica / EEUU / Europa: U$D 100</p>
          </div>
          <div className='col-10 col-md-5 border p-3'>
            <p className='text-center'><strong>Formación para Médicos</strong></p>
            <p>El valor del curso es:</p>
            <p>🇦🇷 Argentina: U$D 150</p>
            <p>🌎 Latinoamérica / EEUU / Europa: U$D 340</p>
          </div>
        </div>
      </div>
      <div className='my-3'>
